 ...
 * @return An owning reference to the deserialized MLIR module, or null after an
 *         import error has been diagnosed. Deserializer and Cap'n Proto errors
 *         do not escape this boundary as exceptions.
 */
